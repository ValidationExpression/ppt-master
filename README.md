...
> Don't expect it to hand you a finished, perfect deck in one shot. Its real value is taking most of the tedious work off your plate; the polishing that's left is still yours to do — and the cheaper the model, the more of it falls on you. How good the result turns out comes down to your skill with this project and with PowerPoint.
